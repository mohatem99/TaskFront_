  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed z-50 fixed w-60 h-screen transition-transform -translate-x-full sm:translate-x-0 ${
...
<div>
          <svg className="flex justify-center items-center py-4"
            width="70"
            height="110"
            viewBox="0 0 80 80"
            fill="none"
        ...
        {/* pages */}
          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M21 16.5H25.5C28.815 16.5 31.5 13.815 31.5 10.5C31.5 7.185 28.815 4.5 25.5 4.5C22.185 4.5 19.5 7.185 19.5 10.5V15C19.5 15.825 20.175 16.5 21 16.5Z" fill="#7E95FF"/>
                        <path d="M16.5 15V10.5C16.5 7.185 13.815 4.5 10.5 4.5C7.185 4.5 4.5 7.185 4.5 10.5C4.5 13.815 7.185 16.5 10.5 16.5H15C15.825 16.5 16.5 15.825 16.5 15Z" fill="currentColor"/>
                        <path d="M19.5 21V25.5C19.5 28.815 22.185 31.5 25.5 31.5C28.815 31.5 31.5 28.815 31.5 25.5C31.5 22.185 28.815 19.5 25.5 19.5H21C20.175 19.5 19.5 20.175 19.5 21Z" fill="currentColor"/>
                        <path d="M15 19.5H10.5C7.185 19.5 4.5 22.185 4.5 25.5C4.5 28.815 7.185 31.5 10.5 31.5C13.815 31.5 16.5 28.815 16.5 25.5V21C16.5 20.175 15.825 19.5 15 19.5Z" fill="currentColor"/>
                    </svg>           
                    <span className="flex-1 m-2 font-bold whitespace-nowrap">
                  Dashboard
                </span>
              </Link>
            </li>
            ...
            <Link
              ...
              >
                    <svg className="w-8 h-8" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M30 12H25.5C23.0175 12 21 9.9825 21 7.5V3L30 12Z" fill="#CCCCCC"/>
                        <path d="M19.875 8.625V3H10.5C8.0175 3 6 5.0175 6 7.5V28.5C6 30.9825 8.0175 33 10.5 33H25.5C27.9825 33 30 30.9825 30 28.5V13.125H24.375C21.8925 13.125 19.875 11.1075 19.875 8.625Z" fill="#10197A"/>
                    </svg>
