      ...
      >
        <div className="h-full py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center p-2 mb-4 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
          >
          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 font-bold whitespace-nowrap">
                  Dashboard
                </span>
              </Link>
            </li>
