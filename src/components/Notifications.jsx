      ...
      <div className="flex gap-8">
        <Popover>
          ...
          <PopoverPanel
            transition
            anchor="bottom"
            className="divide-y divide-white/5 h-1/2 mt-2 rounded-lg border bg-[#fef65b] text-sm/6 transition duration-200 ease-in-out data-[closed]:-translate-y-1 data-[closed]:opacity-0 z-40"
          >
